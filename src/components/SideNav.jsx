      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {/* Left group (icon + animated label) */}
              <Box sx={{ display: "flex", alignItems: "center", minWidth: 0 }}>
                {/* Fixed icon wrapper prevents shifting */}
                <Box
                  sx={{
                    width: 24,
                    height: 24,
                ...
                {/* Animated label wrapper (no mount/unmount) */}
                <Box
                  sx={{
                    overflow: "hidden",
                    whiteSpace: "nowrap",
                    ...
                    transition: prefersReducedMotion
                      ? "none"
                      : "max-width 220ms cubic-bezier(0.2,0,0,1), opacity 160ms ease, margin-left 220ms cubic-bezier(0.2,0,0,1)",
                  }}
                >
                  <Typography
                    fontSize={12}
              ...
              {/* Apps icon (keep space stable; fade out when collapsed) */}
              <Box
                onClick={(e) => {
                  e.stopPropagation();
                  openProductMenu(e);
                ...
                sx={{
                  ...
                  // Hide smoothly without layout jump
                  opacity: collapsed ? 0 : 1,
